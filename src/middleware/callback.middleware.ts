...
export function callback_middleware<Type extends HasCallback>(): Middleware<Type, CallbackContext | void> {
  return (ctx) => {
...
export function data_callback_middleware<Type extends CallbackContext>(): Middleware<Type, DataCallbackContext | void> {
  return (ctx) => {
...
export function message_callback_middleware<Type extends CallbackContext>(): Middleware<Type, MessageCallbackContext | void> {
  return (ctx) => {
