...
export function message_middleware<Type extends HasMessage>(): Middleware<Type, MessageContext | void> {
  return (ctx) => {
...
export function text_message_middleware<Type extends MessageContext>(): Middleware<Type, TextMessageContext | void> {
  return (ctx) => {
