...
export async function use_toggle_trader_off(telegram_controller: TelegramController, user_manager: UserManager): Promise<void> {
  ...
  await default_logger.info("Registration use_toggle_trader_off is finish");
}
